<template>
  <div class="single_input_show" @mouseover="showTure" @mouseout="showFalse" @click="edit">
    <label :style="{
    ...
    }" v-model="data.base.value" v-verify="{vfy:[data.base.req == 'true' ? 'required' : '' , 'length-15', 'email'], use: use || 'false'}"
    />
